...
class HorarioAulaPage extends StatefulWidget {
  @override
  _HorarioAulaPageState createState() => _HorarioAulaPageState();
}

class _HorarioAulaPageState extends State<HorarioAulaPage> {
